...
<?php include_once __DIR__ . "/../menu.php"; ?>
    ...
    <form action="" style="max-width:650px;margin:auto" class="formulario" method="post">
        ...
        <div class="input-container">
            ...
            <input class="input-field" type="text" placeholder="Digite o nome da empresa" name="ems_nome">
        </div>
    ...
    <h2 style="color: #0c5460; margin-top: 15px">Lista de empresas</h2>
    ...
    <table id="customers">
        ...
        <?php foreach ($aTdEmpresas as $aEmpresa): ?>
            <tr>
                <td><?php echo $aEmpresa['ems_nome'];?></td>
                <td><a href="/empresa/editado?ems_id=<?php echo $aEmpresa['ems_id'];?>" <i class="fa fa-pencil-square-o"></i></a></td>
                <td><a href="/empresa/excluir/?ems_id=<?php echo $aEmpresa['ems_id'];?>" <i class="fa fa-trash-o"></i></a></td>
            </tr>
        <?php endforeach; ?>
    </table>
