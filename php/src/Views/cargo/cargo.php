...
use Jade\Avaliacao\Controller\CargoController;
...
<?php include_once __DIR__ . "/../menu.php"; ?>
    ...
    <form action="" style="max-width:650px;margin:auto" class="formulario" method="post">
        ...
        <div class="input-container">
            ...
            <input class="input-field" type="text" placeholder="Digite o nome da situação" name="cao_nome">
        </div>
    ...
    <h2 style="color: #0c5460; margin-top: 15px">Lista de Cargos</h2>
    ...
    <table id="customers">
        ...
        <?php foreach ($aTdSituacoes as $aSituacao): ?>
            <tr>
                <td><?php echo $aSituacao['cao_nome'];?></td>
                <td><a href="/cargo/editado?cao_id=<?php echo $aSituacao['cao_id'];?>" <i class="fa fa-pencil-square-o"></i></a></td>
                <td><a href="/cargo/excluir/?cao_id=<?php echo $aSituacao['cao_id'];?>" <i class="fa fa-trash-o"></i></a></td>
            </tr>
        <?php endforeach; ?>
    </table>
